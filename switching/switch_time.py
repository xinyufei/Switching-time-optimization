...
def test_optimize_sur():
    ...
    initial_control = "../result/control/Rounding/Energy2_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_SUR.csv"
    ...
    if not os.path.exists("../result/output/SwitchTime/test/"):
        os.makedirs("../result/output/SwitchTime/test/")
    ...
    # output file
    output_name = "../result/output/SwitchTime/" + "{}_evotime_{}_n_ts{}_n_switch{}_init{}_minuptime{}_instance{}".format(
    ...
    # retrieve control
    control_name = "../result/control/SwitchTime/" + "{}_evotime_{}_n_ts{}_n_switch{}_init{}_minuptime{}_instance{}".format(
    ...
    # figure file
    figure_name = "../result/figure/SwitchTime/" + "{}_evotime_{}_n_ts{}_n_switch{}_init{}_minuptime{}_instance{}".format(
...
def test_optimize_sample():
    ...
    # initial_control = "../result/control/Trustregion/Energy4_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_instance5_alpha0.01_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    initial_control = "../result/control/Continuous/Energy4_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_instance1.csv"
...
def test_optimize_sample_compile():
    ...
    # initial_control = "../result/control/Continuous/MoleculeNEW_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0.csv"
    # initial_control = "../result/control/Continuous/MoleculeVQE_LiH_evotime20.0_n_ts200_ptypeWARM_offset0.5_objUNIT_sum_penalty0.1.csv"
    # initial_control = "../result/control/ADMM/MoleculeADMMNew_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_sum_penalty1.0_penalty0.001_ADMM_0.5_iter100.csv"
    # initial_control = "../result/control/ADMM/MoleculeVQEADMM_LiH_evotime20.0_n_ts200_ptypeWARM_offset0.5_sum_penalty0.1_penalty0.001_ADMM_3.0_iter100.csv"
    # initial_control = "../result/control/Trustregion/MoleculeNew_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0_alpha0.001_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    initial_control = "../result/control/Trustregion/MoleculeVQE_LiH_evotime20.0_n_ts200_ptypeWARM_offset0.5_objUNIT_sum_penalty0.1_alpha0.001_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    ...
    # output file
    output_name = "../result/output/SwitchTime/" + "{}_evotime_{}_n_ts{}_n_switch{}_init{}_minuptime{}".format(
    ...
    # retrieve control
    control_name = "../result/control/SwitchTime/" + "{}_evotime_{}_n_ts{}_n_switch{}_init{}_minuptime{}".format(
        name + "_" + molecule, str(evo_time), str(n_ts), str(num_switch), initial_type,
        str(min_up_time)) + ".csv"
    ...
    # figure file
    figure_name = "../result/figure/SwitchTime/" + "{}_evotime_{}_n_ts{}_n_switch{}_init{}_minuptime{}".format(
        name + "_" + molecule, str(evo_time), str(n_ts), str(num_switch), initial_type,
        str(min_up_time)) + ".png"
...
def test_optimize_minup():
    ...
    # initial_control = "../result/control/ADMM/EnergyADMM4_evotime2.0_n_ts40_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100_instance1.csv"
    initial_control = "../result/control/Trustregion/Energy4_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_instance5_alpha0.01_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    # initial_control = "../result/control/Target/Energy4_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_instance1.csv"
    warm_start_length, num_switch, ctrl_hamil_idx = obtain_switching_time_uncertain(
        initial_control, evo_time / n_ts, step, ub_threshold, lb_threshold)
    # if min_up_time > 0:
    #     warm_start_length, num_switch, ctrl_hamil_idx = reduce_switch(
...
def draw_sur_metric():
    ...
    # initial_control = "../result/control/ADMM/EnergyADMM2_evotime2.0_n_ts40_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100.csv"
    initial_control = "../result/control/ADMM/EnergyADMM6_evotime2.0_n_ts40_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100_instance1.csv"
    # initial_control = "../result/control/Trustregion/Energy2_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    # initial_control = "../result/control/Continuous/Energy2_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5.csv"
    ...
    fig_name = "../result/figure/SwitchTime/" + "{}_evotime_{}_n_ts{}_instance{}_metric".format(
...
def draw_sur_metric_compile():
    ...
    fig_name = "../result/figure/SwitchTime/" + "{}_evotime_{}_n_ts{}_init{}_metric".format(
...
def test_optimize_gradient():
    ...
    # initial_control = "../result/control/ADMM/EnergyADMM2_evotime2.0_n_ts40_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100.csv"
    # initial_control = "../result/control/ADMM/EnergyADMM2_evotime2.0_n_ts240_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100_instance0.csv"
    initial_control = "../result/control/ADMM/EnergyADMM4_evotime2.0_n_ts120_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100_instance1.csv"
    # initial_control = "../result/control/ADMM/EnergyADMM6_evotime2.0_n_ts40_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100_instance5_extend_ts_80.csv"
    # initial_control = "../result/control/Trustregion/Energy2_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    # initial_control = "../result/control/Continuous/Energy2_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5.csv"
    switches = Switches(initial_control, delta_t=evo_time / n_ts)
    start1 = time.time()
...
def test_optimize_gradient_compile():
    ...
    # target = "../result/control/Target/MoleculeVQE_BeH2_evotime5.0_n_ts50_target.csv"
    # target = "../result/control/Target/MoleculeVQE_BeH2_evotime3.0_n_ts60_target.csv"
    initial_type = "ave"
    Hops, H0, U0, U = generate_molecule_func(qubit_num, d, molecule)
    ...
    # initial_control = "../result/control/ADMM/MoleculeADMMNew_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_sum_penalty1.0_penalty0.001_ADMM_0.5_iter100.csv"
    initial_control = "../result/control/ADMM/MoleculeVQEADMM_LiH_evotime20.0_n_ts200_ptypeWARM_offset0.5_sum_penalty0.1_penalty0.001_ADMM_3.0_iter100.csv"
    # initial_control = "../result/control/ADMM/MoleculeADMM_BeH2_evotime3.0_n_ts60_ptypeWARM_offset0.5_sum_penalty1.0_penalty0.001_ADMM_3.0_iter100.csv"
    # initial_control = "../result/control/Trustregion/MoleculeNew_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0_alpha0.001_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    # initial_control = "../result/control/Trustregion/MoleculeVQE_LiH_evotime20.0_n_ts200_ptypeWARM_offset0.5_objUNIT_sum_penalty0.1_alpha0.001_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv"
    ...
    # initial_control = "../result/control/ADMM/MoleculeADMM_BeH2_evotime5.0_n_ts200_ptypeWARM_offset0.5_sum_penalty0.01_penalty0.001_ADMM_3.0_iter30.csv"
    # initial_control = "../result/control/ADMM/MoleculeADMM_BeH2_evotime20.0_n_ts200_ptypeWARM_offset0.5_sum_penalty0.01_penalty0.001_ADMM_3.0_iter100.csv"
    # initial_control = "../result/control/Continuous/MoleculeVQE_BeH2_evotime20.0_n_ts200_ptypeWARM_offset0.5_objUNIT_sum_penalty0.01.csv"
    # initial_control = "../result/control/ADMM/MoleculeADMMNew_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_sum_penalty1.0_penalty0.001_ADMM_0.5_iter100_extend_ts_400.csv"
    # initial_control = "../result/control/Rounding/MoleculeADMMNew_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_sum_penalty1.0_penalty0.001_ADMM_0.5_iter100_1_SUR.csv"

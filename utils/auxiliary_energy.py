...
if __name__ == "__main__":
        ...
        for seed in seeds:
                ...
                # print(sorted(get_diag(Jij))[2])
                print(sorted(get_diag(Jij))[0])
                # print(1 - sorted(get_diag(Jij))[2] / sorted(get_diag(Jij))[0])
        # exit()
        ...
        print((B_mat.conj().T == B_mat).all())
        print((C_mat.conj().T == C_mat).all())
        exit()
